...
// funkcja zwraca calke funkcji f(x) w przedziale [a,b],
// ktorej wartosci sa podane tabelarycznie w 2n+1 punktach
...
// funkcja zwraca calke znanej w postaci wzoru funkcji f(x)
// w przedziale [a,b], N - ilosc podzialow
...
int main(){
 cout << "Wartosc calki =" << simpson(f,-5,3) << endl; // 82.667
 cout << "Wartosc calki =" << simpson_f(fun,-5,3,8) << endl; // 82.667
 return 0;
}
