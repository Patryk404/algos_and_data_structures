#include <iostream>
using namespace std;
const int n=5; // rzad obliczanych roznic centralnych wynosi n-1
...
double t[n][n+1]= {
 ...
 {0.9, 5.85}, // (wpisane sa dwie pierwsze kolumy, a nie wiersze)
 {1,   7.00},
  {1.1, 8.25},
 {1.2, 9.60}
 #else
...
// funkcja zwraca wartosci f'(z) i f''(z) gdzie z jest elementem centralnym: tutaj t[2][0]; tablica 't' musi byæ uprzednio centralnie
// zainicjowana, jej poprawnosc nie jest sprawdzana
 POCHODNE res;
